...
smallrotX::usage = "Gives the small rotation matrix with respect to X"
smallrotY::usage = "Gives the small rotation matrix with respect to Y"
smallrotZ::usage = "Gives the small rotation matrix with respect to Z"
...
smallrotX[\[Theta]_]:=
	Module[{},
		Return[{{1, 0, 0}, {0, 1, -\[Theta]},{0, \[Theta], 1}}];
	];


smallrotY[\[Theta]_]:=
	Module[{roty},
		roty = {{1, 0, \[Theta]}, {0, 1, 0}, {-\[Theta], 0, 1}};
		Return[roty];
	];
...
smallrotZ[\[Theta]_]:=
	Module[{rotz},
		rotz = {{1, -\[Theta], 0}, {\[Theta], 1, 0}, {0, 0, 1}};
		Return[rotz];
	];
